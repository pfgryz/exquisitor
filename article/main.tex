...
\author*[1]{\fnm{Robert} \sur{Nowak}}\email{robert.nowak@pw.edu.pl}
    ...
    \todo{ We developed a tool with command-line interface, called Exquisitor that implements presented method.}
    ...
    The rest of the paper is organized as follows. Section 2 defines the problem, presents the proposed approach, and provides detailed implementation details \todo{of new tool called Exquisitor}.
    ...
    \subsection{\todo{Exquisitor method description}}
    ...
    The dissimilarity between sequence representations will be calculated using cosine dissimilarity, expressed by the formula in equation \eqref{Equation:CosineDissimilarity}.
        ...
        \subsection{Experiments}
            \subsubsection{Metagenomic identification execution time \todo{using Exquisitor}}
                \paragraph{Objective}
