...
Future research could focus on utilising artificial neural networks as an independent tool for metagenomic identification. Another promising direction is the application of artificial neural networks for dimensionality reduction of genetic sequences, which may improve efficiency and performance in various analyses. We also plan to apply the feature selection techniques successfully used in other bioinformatics pipelines~\cite{noor2024deep}.
Planned development efforts are focused on providing interfaces for the Exquisitor tool, enabling its integration with existing popular metagenomic pipelines. Moreover, the usage of distributed computing and cluster computing platforms will be provided~\cite{noor2025optimizing}.
