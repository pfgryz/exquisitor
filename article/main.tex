...
\section{Introduction}
        ...
        \subsection{Experiments}
            \subsubsection{Execution Time of Metagenomic Identification with Exquisitor}
                ...
                \begin{enumerate}
                    ...
                    \item {
                        The number of clusters was set to $k = \sqrt{n}$, where $n$ is the number of input sequences.
                    }
                \end{enumerate}
    ...
    \section{Conclusions}
        ...
        \subsection{Future Research Directions}
            ...
            Beyond metagenomic identification, the learned sequence representations and clustering approach could be explored in future work for related tasks such as genome assembly, cell-subtype identification, and phylogenetic-tree construction.
