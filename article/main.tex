    ...
    The dissimilarity between sequence representations will be calculated using cosine dissimilarity, expressed by the formula in equation~\eqref{Equation:CosineDissimilarity}.
        ...
        \subsection{Experiments}
            ...
            \subsubsection{Generalisation and $k$ parameter}
                ...
                \paragraph{Results}
                Accurracy, precision, recall and F1 scores for the different values of the $k$ parameter are presented in Table~\ref{Table:Experiment:GeneralisationAndKParameter}.
