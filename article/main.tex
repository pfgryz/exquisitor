...
\begin{document}
    ...
    \history{Date of publication xxxx 00, 0000, date of current version November 2, 2025.}
    \doi{}

    \title{Accelerating Metagenomic Identification of DNA Sequences Using Artificial Neural Networks}
    ...
    \author{
        \uppercase{Patryk F. Gryz}\authorrefmark{1},
        \uppercase{Robert Nowak}\authorrefmark{1}
    }
    ...
    \address[1]{
        ...
        (e-mail: patryk.gryz.stud@pw.edu.pl; robert.nowak@pw.edu.pl)
    }

    \markboth
    {P. F. Gryz and R. Nowak: Accelerating Metagenomic Identification of DNA Sequences Using Artificial Neural Networks}
    {P. F. Gryz and R. Nowak: Accelerating Metagenomic Identification of DNA Sequences Using Artificial Neural Networks}

    \corresp{Corresponding author: Patryk F. Gryz (e-mail: patryk.gryz.stud@pw.edu.pl).}

    \tfootnote{
        This work is supported by a statutory Research Grant from the Institute of Computer Science, Warsaw University of Technology, Warsaw, Poland.
    }
    ...
    With the development of next-generation sequencing methods\cite{Reinartz:2002}, sequencing costs have decreased significantly, and the number of DNA sequences being analysed has increased\cite{Muir:2016}.
    ...
    A notable example of an interesting tool is the development of the MetaPhlAn tool in 2012 \cite{Segata:2012}, which uses marker genes to compare the species composition of metagenomic samples.
    Another marker gene-based approach is mOTUs2 \cite{Milanese:2019}, which identifies and analyses markers unique to specific microbial strains.
    ...
    An unconventional method for metagenomic identification was proposed in 2022 with BERTax \cite{Mock:2022}, which applies a transformer model \cite{Transformers} to DNA sequence analysis,
    ...
    The dissimilarity between sequence representations will be calculated using cosine dissimilarity, expressed by the formula in equation~\eqref{Equation:CosineDissimilarity}.
            ...
            \subsubsection{Artificial Neural Network}
                ...
                The ANN model consists of two parts. The first part comprises two convolutional blocks with batch normalisation and is responsible for feature extraction from the sequence. The second part utilises fully connected layers with dropout and the GELU activation function \cite{Hendrycks:2016} and is connected to the first part of the model via a flattening layer.
                ...
                \paragraph{Input}
                The input to the model consists of DNA sequences of length $150$\footnote{The sequence length of 150 is a method parameter and can be adjusted depending on the application.}, which are encoded into a vector of dimensions $1 \times 600$ using one-hot encoding \cite{HarrisDavid:2007}.
                ...
                The proposed loss function is similar to the triplet neural network framework\cite{hoffer2018deepmetriclearningusing}, but it is adapted to use cosine dissimilarity.

                \paragraph{Learning}
                The model was trained on a dataset of $10^{6}$ training examples and $10^{4}$ validation examples. The optimiser used was \textit{AdamW}\cite{Loshchilov2017DecoupledWD}, and the training was performed for 100 epochs.
        ...
        \subsection{Exquisitor: Implementation Details}
            ...
            The console application was implemented using the \textit{clap} library\cite{Rust:clap}. In the library the $k$-medoid algorithm was provided by the \textit{kmedoids} library\cite{Rust:kmedoids}, and the neural network was built using the \textit{burn} library\cite{Rust:burn} with the \textit{wgpu} execution environment. Web application was implemented using the \textit{axum} library\cite{Rust:axum} with \textit{tokio}\cite{Rust:axum} async environment.
    ...
    \section{Conclusions}
        ...
        \subsection{Future Research Directions}
            Future research could focus on utilising artificial neural networks as an independent tool for metagenomic identification. Another promising direction is the application of artificial neural networks for dimensionality reduction of genetic sequences, which may improve efficiency and performance in various analyses. We also plan to apply the feature selection techniques successfully in other bioinformatics pipelines~\cite{noor2024deep}.
    ...
    \begin{IEEEbiographynophoto}{Patryk F. Gryz} 
        received the B.S. degree in computer science from the Warsaw University of Technology, Warsaw, Poland in 2025. He is currently pursuing the M.S. degree in computer science at the Warsaw University of Technology, Warsaw, Poland.
        
        His research interests include software engineering, artificial intelligence, and bioinformatics.
    \end{IEEEbiographynophoto}

    \begin{IEEEbiographynophoto}{Professor Robert Nowak, Ph.D, D.Sc.}
        is a full professor and Deputy Director for Research at Institute of Computer Science, Faculty of Electronics and Information Technology, Warsaw University of Technology, Warsaw, Poland.
