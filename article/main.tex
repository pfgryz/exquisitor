...
\title[Article Title]{Accelerating Taxonomic Classification
    \todo{lepszy termin: Metagenomic identification}
  of DNA Sequences Using Artificial Neural Networks}
    ...
    \keywords{DNA sequencing, taxonomic classification, artificial neural networks, contrastive learning, sequence clustering}
