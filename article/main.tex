...
\begin{document}
    ...
    \author{
        \IEEEauthorblockN{
            Patryk Filip Gryz\IEEEauthorrefmark{1},
            Robert Nowak\IEEEauthorrefmark{2}
        }
        \\
        \IEEEauthorblockA{
        ...
        \\
        Email:
        \IEEEauthorrefmark{1}patryk.gryz.stud@pw.edu.pl,
        \IEEEauthorrefmark{2}robert.nowak@pw.edu.pl
    }
    ...
    \begin{IEEEkeywords}
    DNA sequencing, metagenomic identification, artificial neural networks, contrastive learning, sequence clustering.
    \end{IEEEkeywords}
    ...
    The dissimilarity between sequence representations will be calculated using cosine dissimilarity, expressed by the formula in equation \eqref{Equation:CosineDissimilarity}.
            ...
            \subsubsection{Artificial Neural Network}
                ...
                \begin{figure}[!t]
                    \begin{center}
                        \includegraphics[width=0.5\textwidth]{picture_ann_network.png}
                    \end{center}
                    \caption{
