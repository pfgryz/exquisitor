...
\todo{sprawdzenie słów, 'speller'}
\todo{usunąć wdowy i sieroty, tzn. twarda spacja po samotnej literze, twarda spacja to tylda}
...
\todo{zmienilem glebokosc TOC, do sprawdzenia}
