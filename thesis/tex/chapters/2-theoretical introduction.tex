\cleardoublepage
\section{Metody wykorzystywane w pracy, istniejące rozwiązania}
\todo{proponuję zmianę tytułu}
    ...
    \subsection{Kluczowe pojęcia i definicje}
        ...
        \todo{alfabet oznaczać inaczej, nie 'G' ale np. $\mathbb{A}$}
        ...
        \todo{problem z cytowaniem \cite{Bromley1993}}
