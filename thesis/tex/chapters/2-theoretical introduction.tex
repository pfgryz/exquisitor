...
\section{Wstęp teoretyczny}
    ...
    \subsection{Przegląd literatury}
        ...
        \todo{
            ...
            \textbf{Luka badawcza}
            Brak narzędzi korzystających ze sztucznych sieci neuronowych
        }
    ...
    \subsection{Teoretyczne podstawy problemu}
        ...
        \todo{
            DO NAPISANIA\\
            \textbf{Opisać sieci neuronowe}
            \begin{itemize}
                \item Warstwy
                \item Perceptron
                \item Sieć splotowa
                \item Wygaszanie (Dropout)
                \item Normalizacja wsadowa (BatchNorm)
                \item Warstwa spłaszczająca
                \item Wektor zanurzeń
                \item GELU
            \end{itemize}
        }
