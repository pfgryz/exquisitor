...
\section{Eksperymenty}
    ...
    \subsection{Opis środowiska eksperymentalnego}
        ...
        \todo{zakomentowałem podrozdział, bo nieistotny}
    ...
    \subsection{Miara jakości}
        ...
        \todo{RN:zmieniłem wzór~\ref{Equation:WeightedAverageQuality}, bo tak jest trochę jaśniej}
    ...
    \subsection{Wyniki}
                ...
                \begin{table}\centering
                    ...
                    \begin{tabularx}{\textwidth}{|c||R|R|R|R|}
                        ...
                        \multirow{2}{*}{\textbf{Liczba sekwencji}} & \multicolumn{4}{|c|}{\textbf{Czas trwania eksperymentu}} \\ \cline{2-5}
                                        & \textbf{BZ} & \textbf{NW} & \textbf{$k$-mer} & \textbf{SNN} \\ \hline \hline
        ...
        \subsubsection{Eksperyment 2: Jakość klasyfikacji taksonomicznej}
            ...
            \paragraph{Wyniki}
                ...
                \begin{figure}
                    \begin{center}
                        \input{tex/pictures/exp/experiment_relative_quality.tex}
                    \end{center}
                    \caption{
                ...
                \begin{table}\centering
                  \todo{RN:rozbić tabele na metody?}
