\cleardoublepage
\section{Badanie jakości i wydajności zaproponowanago rozwiązania}
\todo{zmieniłem tytuł}
    ...
    % ===== ===== ===== =====
        ...
        \subsubsection{Eksperyment 2: Jakość klasyfikacji taksonomicznej}
            ...
            \paragraph{Wyniki}
                ...
                \begin{figure}
                    \begin{center}
                        \input{tex/pictures/exp/experiment_relative_quality_nmi.tex}
                    \end{center}
                    \caption{
                ...
                \begin{figure}
                    \begin{center}
                        \input{tex/pictures/exp/experiment_relative_quality_sensitivity.tex}
                    \end{center}
                    \caption{
