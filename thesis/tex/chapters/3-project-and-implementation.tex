...
\section{Projekt i Implementacja}
    ...
    \todo{zdanie niedokończone, proszę zakończyć, np. 'spełniać wymagania funkcjonalne i niefunkcjonalne.'}
        ...
        \subsubsection{Wymagania niefunkcjonalne}
            ...
            \item Aplikacja powinna być wykonana przy wykorzystaniu kompilowanego wysoko wydajnego języka programowania.
              \todo{może lepiej:
                'Aplikacja powinna być wydajna. Wymaga to wykorzystanie języka programowania pozwalającego tworzyć
                wydajny kod wykonywalny.'}
    ...
    \subsection{Model architektury rozwiązania}
        ...
        \todo{nie bardzo widzę sens robić 'input' pliku 'tex', który ma 'includegraphics'. Proszę bezpośrednio dać 'includegraphics' i usunąć pliki 'tex' z 'tex/pictures'}

        \todo{dla każdego środowiska 'figure' dać '[!htb]' jak niżej}
        
        \begin{figure}[!htb]
            \begin{center}
                \input{tex/pictures/app/c4_system_context.tex}
            \end{center}
            \caption{
        ...
        \begin{figure}
            \begin{center}
                \input{tex/pictures/app/c4_container.tex}
            \end{center}
            \caption{
    ...
    Centralnym elementem rozwiązania jest potok przetwarzania, zaprojektowany z myślą o elastycznej konfiguracji oraz możliwości zastosowania różnych metod grupowania sekwencji DNA. Elementy potoku zostały zaimplementowane w bibliotece \textit{exquisitor-core}, w postaci funkcji oraz rekordów. Realizacja potoku została umieszczona w aplikacji konsolowej, która wykorzystuje tę bibliotekę. Aplikacja umożliwia uruchamianie i konfigurację potoku, oferując dostęp do dostępnych metod. Zawiera również polecenia pomocnicze, które zostały przygotowane w celu przeprowadzenia eksperymentów.
        ...
        \subsubsection{Potok przetwarzania}
            ...
            \todo{dodać na początku: 'Potok przetwarzania został pokazany na Rys. XXX'}
        ...
        \subsubsection{Aplikacja internetowa \texttt{exquisitor-app}}
            ...
            \begin{figure}
                \begin{center}
                    \input{tex/pictures/app/database.tex}
                \end{center}
                \caption{
    ...
    \subsection{Metody grupowania sekwencji}
        ...
        \subsubsection{Zmodyfikowany algorytm Needlemana-Wunscha}\label{Method:NeedlemanWunsch}
            ...
            gdzie,
            \todo{popatrz na moje zmiany w równaniu \eqref{Equation:NeedlemanWunsch}, linijka powyżej do wyrzucenia}
            \begin{align*} 
        ...
        \subsubsection{Metoda zanurzeń \textit{k-merów}}
          ...
          \todo{zmienić kolejność AG i AT, żeby było alfabetycznie}
          \todo{dodać jeszcze $TT \to 15$ po $\dots$}
          ...
          \todo{dać cały wektor, 16 liczb, bez $\dots$}
    ...
    \subsection{Interfejs użytkownika}
        ...
        \subsubsection{Opis interfejsu użytkownika}
            ...
            \paragraph{Aplikacja internetowa}
                ...
                \begin{figure}
                  \todo{usunąć (przyciąć) rysunek, bo dużo 'pustego', podobnie inne zrzuty}
                    \begin{center}
                        \input{tex/pictures/app/web_screen.tex}
                    \end{center}
                    \caption{
        ...
        \subsubsection{Instrukcja użytkownika}
            ...
            \paragraph{Przykładowe wykorzystanie aplikacji internetowej}
                ...
                \begin{figure}
                    \begin{center}
                        \input{tex/pictures/app/web_search_success.tex}
                    \end{center}
                    \caption{
                        Strona zlecenia.
                ...
                \begin{figure}
                    \begin{center}
                        \input{tex/pictures/app/web_search_failure.tex}
                    \end{center}
                    \caption{
